...
const path_clean_abaumanii = path.join(__dirname, '../assets/webscrap/clean/abaumanii/clean_ab.csv');
const path_clean_all_ab = path.join(__dirname, '../assets/webscrap/clean/abaumanii/cleanAll_ab.csv');
