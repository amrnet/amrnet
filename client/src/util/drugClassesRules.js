...
export const drugRulesINTS = [
  ...
  { key: 'Ciprofloxacin (nonsusceptible)', columnID: 'QUINOLONE', values: ['QUINOLONE'] },
...
export const statKeysINTS = [
  ...
  { name: 'Ciprofloxacin (nonsusceptible)', column: 'QUINOLONE', key: 'QUINOLONE', resistanceView: true },
