...
const ExcludedView = ['Genotype prevalence', 'NG-MAST TYPE prevalence'];
const mapViewsWithZeroPercentOption = ['CipNS', 'CipR', 'AzithR', 'MDR', 'XDR', 'H58 / Non-H58', 'ESBL', 'Carb', 'Genotype prevalence', 'NG-MAST TYPE prevalence'];
...
export const TopRightControls = () => {
  ...
  function handleChangeMapView(event) {
    if(event.target.value === 'Genotype prevalence' || event.target.value === 'NG-MAST TYPE prevalence')
