  ...
  async function handleClickDownloadPDF() {
    ...
    try {
      ...
      if (organism === 'styphi') {
        ...
        doc.setFont(undefined, "italic");
        doc.text(texts[3], 155, 145, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[4], 247, 145, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[5], 16, 165, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        ...
        doc.setFont(undefined, "italic");
        doc.text(texts[10], 35, 215, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[11], 35+kleb, 215, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[12], 16, 225, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[13], 16, 235, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[14], 16, 245, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[15], 16, 255, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[16], 240, 255, { align: 'left', maxWidth: pageWidth - 36 });
         doc.setFont(undefined, 'normal');
        doc.text(texts[17], 332, 255, { align: 'left', maxWidth: pageWidth - 36});
        doc.text(texts[18], 16, 265, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[19], 16, 295, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[20], 198, 295, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[21], 16, 305, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setTextColor(0,0,0)
        doc.text(texts[22], 16, 325, { align: 'left', maxWidth: pageWidth - 36 });

        doc.text(texts[23], 16, 355, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[24], 60, 355, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[25], 60+kleb, 355, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'bold');
        doc.text(texts[26], 16, 375, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[27], 16, 385, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[28], 16, 395, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[29], 16+kleb, 395, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[30], 16, 405, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[31], 16, 435, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'bold');
        doc.text(texts[32], 16, 475, { align: 'left', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[33], 16, 485, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[34], 16, 495, { align: 'left', maxWidth: pageWidth - 36 });
        doc.text(texts[35], 16, 505, { align: 'left', maxWidth: pageWidth - 36 });
        // const euFlag = new Image();
        // euFlag.src = EUFlagImg;
        // doc.addImage(euFlag, 'JPG',173,pageHeight-38, 12, 7, undefined,'FAST');
      }else if (organism === 'ngono') {
