  ...
  async function handleClickDownloadPDF() {
    ...
    try {
      ...
      if (organism === 'styphi') {
        ...
        doc.setFont(undefined, 'normal');
        doc.text(texts[2], 16, 135, { align: 'justify', maxWidth: pageWidth - 36});
        doc.setFont(undefined, "italic");
        doc.text(texts[3], 155, 145, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[4], 247, 145, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[5], 16, 165, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[6], 108, 165, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[7], 16, 175, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'bold').setTextColor(108, 57, 184);
        doc.text(texts[8], 16, 205, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[9], 16, 215, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[10], 35, 215, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[11], 35+kleb, 215, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[12], 16, 225, { align: 'justify', maxWidth: pageWidth - 36 });
        ...
        doc.setFont(undefined, "italic");
        doc.text(texts[13], 240, 255, { align: 'justify', maxWidth: pageWidth - 36 });
         doc.setFont(undefined, 'normal');
        doc.text(texts[14], 332, 255, { align: 'justify', maxWidth: pageWidth - 36});
        doc.text(texts[15], 16, 265, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[16], 16, 295, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[17], 198, 295, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[18], 16, 305, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setTextColor(0,0,0)
        doc.text(texts[19], 16, 325, { align: 'justify', maxWidth: pageWidth - 36 });

        doc.text(texts[20], 16, 355, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, "italic");
        doc.text(texts[21], 60, 355, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[22], 60+kleb, 355, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'bold');
        doc.text(texts[23], 16, 375, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[24], 16, 385, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[25], 16, 395, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[26], 16+kleb, 395, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[27], 16, 405, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[28], 16, 435, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'bold');
        doc.text(texts[29], 16, 475, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.setFont(undefined, 'normal');
        doc.text(texts[30], 16, 485, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[31], 16, 495, { align: 'justify', maxWidth: pageWidth - 36 });
        doc.text(texts[32], 16, 505, { align: 'justify', maxWidth: pageWidth - 36 });
        // const euFlag = new Image();
        // euFlag.src = EUFlagImg;
        // doc.addImage(euFlag, 'JPG',173,pageHeight-38, 12, 7, undefined,'FAST');
      }else if (organism === 'ngono') {
