...
ssh -i ~/.ssh/dragon.pem ec2-user@52.86.233.198 \
  "mongodump --uri='mongodb://amrnet_app:AmrNet2026Prod@127.0.0.1:27017/?authSource=admin' --out=/tmp/dev_dump --gzip 2>/dev/null && tar -czf /tmp/dev_dump.tar.gz -C /tmp dev_dump"
