  ...
  collection2.find().forEach(function (doc) {
    ...
    if (
      ...
      (doc['PURPOSE OF SAMPLING'] == 'Non Targeted [Surveillance Study]' ||
        ...
        doc['PURPOSE OF SAMPLING'] == 'Non Targeted [Other]') &&
      doc['SYMPTOM STATUS'] != 'Asymptomatic Carrier' &&
      doc['SOURCE'] != 'Environment' &&
      doc['SOURCE'] != 'Gallbladder'
    ) {
      dView = 'Include';
    } else {
      dView = 'Exclude';
